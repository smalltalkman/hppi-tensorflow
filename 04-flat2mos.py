...
def generate_mos_file(INPUT_FILE, OUTPUT_FILE):
    ...
    while line:
        ...
        if line:
            pairs = line.split(',')
            result = numbers_to_str(mos_code_of(pairs[0])+mos_code_of(pairs[1]))
...
if __name__=="__main__":
    ...
    for FILE in FILES:
        ...
        generate_mos_file(FDD+"/"+FILE, MOSDD+"/"+FILE)
        print("Processed!")
    print("Finished!!!")
