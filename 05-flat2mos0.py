...
def generate_mos0_file(INPUT_FILE, OUTPUT_FILE):
    ...
    while line:
        ...
        if line:
            pairs = line.split(',')
            result = numbers_to_str(mos0_code_of(pairs[0])+mos0_code_of(pairs[1]))
...
if __name__=="__main__":
    if not os.path.exists(MOSDD):
        os.makedirs(MOSDD)
    for FILE in FILES:
        print("Processing "+FILE+" ...")
        generate_mos0_file(FDD+"/"+FILE, MOSDD+"/"+FILE)
        print("Processed!")
    print("Finished!!!")
